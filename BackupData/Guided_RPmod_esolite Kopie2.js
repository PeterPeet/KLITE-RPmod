...
(function() {
    ...
    const UI = {
        ...
        // Section 0: Introduction (2-column layout)
        createSection0() {
            return `
                    ...
                    <div class="section-content">
                        <div class="intro-layout">
                            <div class="intro-header">
                                <div class="intro-thumbnail" style="background-image: var(--img_theme_4);">
                                </div>
                                <div class="intro-text">
                                    <h1 class="intro-title">Welcome to Esolite</h1>
                                    <p class="intro-subtitle">Your guided journey to AI role play chat adventures</p>
                                    <p class="intro-description">
                                        This interactive guide will set you up in <strong>8 simple steps</strong>.<br/>
                                        We will now walk you through:
                                    </p>
                                </div>
                            </div>
                            <div class="intro-steps">
                                <div class="intro-step"><span class="step-num">1</span>(Load Save)</div>
                                <div class="intro-step"><span class="step-num">2</span>Connect AI</div>
                                <div class="intro-step"><span class="step-num">3</span>Writing Style</div>
                                <div class="intro-step"><span class="step-num">4</span>Your Persona</div>
                                <div class="intro-step"><span class="step-num">5</span>Character</div>
                                <div class="intro-step"><span class="step-num">6</span>Greeting</div>
                                <div class="intro-step"><span class="step-num">7</span>Review & Start</div>
                            </div>
    ...
    const STYLES = `
        /* ========== CSS Variables mapped to Esolite theme ========== */
        :root {
            /* Base backgrounds */
            --grp-bg-dark: var(--theme_color_bg_dark);
            --grp-bg: var(--theme_color_bg);
            /* Unify step backgrounds to a single theme tone */
            --grp-bg-blue: var(--grp-bg);
            --grp-bg-purple: var(--grp-bg);
            --grp-bg-pink: var(--grp-bg);
            --grp-bg-green: var(--grp-bg);
            ...
            /* Controls */
            --grp-top-btn-bg: var(--theme_color_topbtn);
            --grp-top-btn-bg-hover: var(--theme_color_topbtn_highlight);
            --grp-button-bg: var(--theme_color_button_bg);
            --grp-button-text: var(--theme_color_button_text);

            /* Typography */
            --grp-font-family: var(--theme_font_family);
            --grp-font-size: var(--theme_font_size_content);

            /* Section overlay gradients for progressive backgrounds */
            --grp-step-0: linear-gradient(180deg, rgba(0,0,0,0.45) 0%, rgba(0,0,0,0.25) 100%);
            --grp-step-1: linear-gradient(180deg, rgba(0,0,0,0.38) 0%, rgba(0,0,0,0.22) 100%);
            --grp-step-2: linear-gradient(180deg, rgba(0,0,0,0.30) 0%, rgba(0,0,0,0.18) 100%);
            --grp-step-3: linear-gradient(180deg, rgba(0,0,0,0.22) 0%, rgba(0,0,0,0.12) 100%);
            --grp-step-4: linear-gradient(180deg, rgba(255,255,255,0.02) 0%, rgba(255,255,255,0.06) 100%);
            --grp-step-5: linear-gradient(180deg, rgba(255,255,255,0.04) 0%, rgba(255,255,255,0.08) 100%);
            --grp-step-6: linear-gradient(180deg, rgba(255,255,255,0.06) 0%, rgba(255,255,255,0.10) 100%);
            --grp-step-7: linear-gradient(180deg, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0.12) 100%);

            --grp-radius: 16px;
            --grp-radius-sm: 8px;
            --grp-transition: 0.3s ease;

            /* Role Play Mode Thumbnail (Base64 PNG) */
        ...
        .nav-dot {
            ...
            height: 16px;
            border-radius: 50%;
            border: 3px solid var(--grp-text-muted);
        ...
        .grp-section[data-theme="blue"] { background: var(--grp-bg-blue); }
        .grp-section[data-theme="purple"] { background: var(--grp-bg-purple); }
        .grp-section[data-theme="pink"] { background: var(--grp-bg-pink); }
        .grp-section[data-theme="green"] { background: var(--grp-bg-green); }
        ...
        .section-content {
            ...
            margin: 0 auto;
            padding: 32px 28px;
            background: transparent; /* float content over section bg */
            border: none;
            border-radius: 0;
            box-shadow: none;
        ...
        .section-number {
            display: none; /* hide step pill */
        }

        .section-header h2 {
            font-size: 3rem; /* match Welcome title scale */
            font-weight: 700;
            margin-bottom: 8px;
            background: linear-gradient(135deg, var(--grp-text) 0%, var(--grp-accent-light) 100%);
        ...
        .persona-method { overflow: hidden; }
        ...
        @media (max-width: 768px) {
            ...
            .writing-style-options { flex-direction: column; }
            ...
            /* Keep Guided nav buttons aligned consistently on mobile too */
            #grp-overlay .section-nav {
                grid-template-columns: 1fr 1fr;
                gap: 12px;
            }
        ...
        /* Section 0: Introduction (rotated layout) */
        .intro-layout { display: flex; flex-direction: column; gap: 20px; max-width: 768px; margin: 0 auto; }

        .intro-header {
            display: flex;
            flex-direction: row-reverse; /* place thumbnail on the right */
            gap: 24px;
            align-items: center;
            justify-content: center; /* center the group above the grid */
        }
    ...
    const EventHandlers = {
        ...
        bindStartModeSection() {
            ...
            if (saveInput) saveInput.addEventListener('change', async (e) => {
        ...
        bindAISection() {
            ...
            { const el = document.querySelector('.toggle-visibility'); if (el) el.addEventListener('click', (e) => {
        ...
        validatePersonaSection() {
            const methodEl = document.querySelector('input[name="persona-method"]:checked');
            const method = methodEl ? methodEl.value : undefined;
            let valid = false;
        ...
        updateFirstMessage() {
            ...
            if (state.config.character && state.config.character.alternate_greetings && state.config.character.alternate_greetings.length > 0) {
