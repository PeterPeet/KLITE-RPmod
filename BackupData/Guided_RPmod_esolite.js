...
(function() {
    ...
    const STYLES = `
        ...
        .intro-step:nth-child(1) { grid-column: 1; grid-row: 1; }
        .intro-step:nth-child(2) { grid-column: 2; grid-row: 2; }
        .intro-step:nth-child(3) { grid-column: 3; grid-row: 1; }
        .intro-step:nth-child(4) { grid-column: 4; grid-row: 2; }
        .intro-step:nth-child(5) { grid-column: 5; grid-row: 1; }
        .intro-step:nth-child(6) { grid-column: 6; grid-row: 2; }
        .intro-step:nth-child(7) { grid-column: 7; grid-row: 1; }
        ...
        /* Additional theme colors for new sections */
        .grp-section[data-theme="teal"] {
            background: rgba(10, 70, 75, 1);
        }

        .grp-section[data-theme="orange"] {
            background: rgba(70, 45, 10, 1);
        }
