...
(function() {
                    ...
                    <div class="section-content">
                        <div class="intro-layout">
                            ...
                            <div class="intro-steps">
                                <div class="intro-step"><span class="step-num">1</span>Start Mode</div>
    ...
    const STYLES = `
        ...
        /* ========== Import/Dropzone ========== */
        .import-zone {
            border: 2px dashed var(--grp-card-border);
            border-radius: var(--grp-radius);
            padding: 40px;
            text-align: center;
            cursor: pointer;
    ...
    const EventHandlers = {
        ...
        bindStartModeSection() {
            // Start fresh button
            document.getElementById('start-fresh-card')?.addEventListener('click', () => {
            ...
            continueCard?.addEventListener('click', () => saveInput?.click());
        ...
        bindGreetingSection() {
            ...
            document.getElementById('use-custom-greeting')?.addEventListener('change', (e) => {
            ...
            // Custom greeting input
            document.getElementById('custom-greeting-text')?.addEventListener('input', (e) => {
        ...
        validateGreetingSection() {
            const hasCustom = document.getElementById('use-custom-greeting')?.checked;
            const customText = document.getElementById('custom-greeting-text')?.value || '';
        ...
        updateOverviewSummary() {
            ...
            document.getElementById('summary-style').textContent =
                state.config.writingStyle ?
                    WRITING_PRESETS[state.config.writingStyle]?.name || 'Normal' :
                    'Normal';
    ...
    function hideSimplifiedChat() {
        ...
        document.getElementById('grp-chat-header')?.remove();
    }
    ...
    function hideOverlay() {
        document.getElementById('grp-overlay')?.remove();
        log('Overlay hidden');
    }
    ...
    function hideGRPHeaderButtons() {
        document.getElementById('grpSwitchBtn')?.parentElement?.remove();
        document.getElementById('grpNewBtn')?.parentElement?.remove();
    }
