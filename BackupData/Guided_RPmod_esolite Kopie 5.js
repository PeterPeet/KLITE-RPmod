...
(function() {
                        ...
                        <div class="intro-layout-corpo">
                            <div class="intro-main">
                                ...
                                <div class="intro-thumbnail-wrapper">
                                    <div class="intro-thumbnail-clickable" data-next="1" style="background-image: var(--img_theme_4);"></div>
                                </div>
    ...
    const STYLES = `
        ...
        .intro-title-corpo::after {
            content: ' Esolite';
            background: linear-gradient(135deg, var(--grp-accent-light) 0%, var(--grp-accent) 100%);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
        }
